...
\restrict tv1zlTHdrPigRoTf5HmmTO2gemDXPkk1sYUVTGFXI6Qd86Mt4niOJDmGaIlyAtH
...
COPY public.service_requests (id, first_name, last_name, address, phone, passport_number, service_description, status, created_at, attachments) FROM stdin;
\.
...
COPY public.support_messages (id, name, phone, email, message, is_read, created_at, attachments) FROM stdin;
1	أحمد تجريبي	+213 500 123 456	\N	أريد الاستفسار عن رحلة العمرة للشهر القادم	f	2026-03-24 04:47:40.752951	[]
2	محمد تجربة	+213 555 999 000	\N	أريد الاستفسار عن رحلة باريس	f	2026-03-24 04:49:03.327842	[]
3	محمد تجربة	+213 555 999 000	\N	أريد الاستفسار عن رحلة باريس	f	2026-03-24 04:49:10.488742	[]
4	فاطمة تجربة	+213 555 111 222	\N	أريد إرفاق وثيقة جواز سفري	f	2026-03-24 04:53:40.148333	[{"name":"passport.jpg","type":"image/jpeg","data":"/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAMCAgMCAgMDAwMEAwMEBQgFBQQEBQoH"}]
5	أحمد اختبار	+213 500 000 111	\N	رسالة تجربة مع مرفق صورة	f	2026-03-24 04:55:54.547521	[{"name":"test-image.png","type":"image/png","data":"iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8BQDwADhQGAWjR9awAAAABJRU5ErkJggg=="}]
\.
...
1	admin@chouiaar.com	750dc4f922d5409cfc2b75c2376b9e3a5ecd4dbc7f181e713de13c2977424823	Admin Chouiaar	\N	admin	380922	\N	t	2026-03-23 02:29:53.439077
\.
...
\unrestrict tv1zlTHdrPigRoTf5HmmTO2gemDXPkk1sYUVTGFXI6Qd86Mt4niOJDmGaIlyAtH
